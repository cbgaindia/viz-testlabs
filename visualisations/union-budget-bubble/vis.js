...
(function() {
  ...
  var selected_year = "Total Budget Estimates 2017-2018";
  ...
  BubbleChart = (function() {
    function BubbleChart(data) {
      ...
      max_amount = d3.max(this.data, function(d) {
        return parseInt(d[selected_year]);
      });
    ...
    BubbleChart.prototype.create_nodes = function() {
      this.data.forEach((function(_this) {
        return function(d) {
          ...
          node = {
            id: d["Department"],
            radius: _this.radius_scale(parseInt(d[selected_year])),
  ...
  $(function() {
    ...
    return d3.csv("ministry-wise-expenditure.csv", render_vis);
  });
